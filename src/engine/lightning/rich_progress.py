...
class RichProgressBar(ProgressBarBase):
    ...
    def _init_progress(self, trainer):
        if self.is_enabled and (self.progress is None or self._progress_stopped):
            ...
            # self.progress._metric_component = self._metric_component
            self.progress.start()
    ...
    def on_train_epoch_start(self, trainer, pl_module):
        ...
        train_description = self._get_train_description(trainer.current_epoch, trainer.max_epochs)
        ...
        info = "Model has been trained {} epoch{}, {} remained.".format(
            trainer.current_epoch, "s" if trainer.current_epoch > 1 else "", trainer.max_epochs - trainer.current_epoch
        )
        self.progress.console.print(info)
    ...
    def _get_train_description(self, current_epoch: int, max_epochs: int) -> str:
        train_description = f"Epoch {current_epoch + 1} / {max_epochs}"
